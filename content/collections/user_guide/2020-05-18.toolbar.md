...
body:
  -
    ...
    content:
      -
        type: text
        text: 'This strip at the top of the Voltage Modular interface is where you’ll load, save, and create sound presets. It also contains basic utility functions such as undo, redo, zoom level, and more. Let’s go over them:'
  -
    type: set
    attrs:
      values:
  ...
  -
    ...
    content:
      ...
      -
        type: text
        text: '- Clicking this hides or shows all cables. It has no effect on sounds, and its status does not save with patches.'
  -
    type: paragraph
    content:
      -
