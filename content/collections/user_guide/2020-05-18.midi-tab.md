...
body:
  ...
  -
    ...
    attrs:
      values:
        type: image
        image:
          - screenshots/ug_midilearn_cutofftab.jpg
        alignment: left
  -
    type: paragraph
    content:
      ...
      -
        type: text
        text: "\_knob \"stays on\" to enable assignment of multiple hardware controls."
  -
    type: paragraph
    content:
      -
  ...
  -
    ...
    content:
      ...
      -
        type: text
        text: '. (Just remember that when we stop learning, we stop growing… oh, forget it…)'
  -
    type: paragraph
    content:
      -
  ...
  -
    ...
    content:
      ...
      -
        type: text
        text: "\_Deletes all controller assignments for the patch. Voltage Modular will display a warning dialog prior to deletion in order to thwart potential disasters"
  -
    type: set
    attrs:
      values:
