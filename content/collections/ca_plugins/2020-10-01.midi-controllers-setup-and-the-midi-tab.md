...
body:
  ...
  -
    ...
    content:
      -
        type: text
        text: 'This is the quick, "I just want to assign a hardware control right now!," section. We recommend reading this whole section to best take advantage of DCO-106''s swift MIDI control assignments. We also recommend reading "'
      -
        type: text
        marks:
          -
            type: italic
        text: 'A Tree Grows In Brooklyn'
      -
        type: text
        text: '" by Betty Smith, but that''s not important right now. '
  -
    type: paragraph
    content:
      -
  ...
  -
    ...
    attrs:
      values:
        ...
        buttons:
          -
            link_text: 'Continue to MIDI MPE Settings section'
