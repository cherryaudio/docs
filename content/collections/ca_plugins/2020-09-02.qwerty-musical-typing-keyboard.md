...
body:
  ...
  -
    ...
    content:
      ...
      -
        type: text
        text: '- Clicking and dragging the right edge of the MTL window allows the overall size of the window to be adjusted. This lets you view more or less of the onscreen keyboard. Note that the MTK window''s borders cannot exceed the overall outside dimensions of the DCO-106. '
  -
    type: paragraph
    content:
      -
      ...
      values:
        ...
        buttons:
          -
            ...
            url: 'https://docs.cherryaudio.com/cherry-audio/virtual-instruments/dco-106/settings'
            target_blank: false
            color: btn-grey
            size: null
            type: button
