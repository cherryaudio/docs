...
body:
  ...
  -
    ...
    content:
      ...
      -
        type: text
        text: '- Displays DCO-106’s current internal tempo setting. DCO-106''s internal tempo affects the '
      -
        type: text
        marks:
          -
  ...
  -
    ...
    attrs:
      values:
        type: image
        image:
          - ug_DCO-106_topToolbar_presetRightClick.jpg
        alignment: left
        add_shadow: false
  -
    type: paragraph
  ...
  -
    ...
    content:
      ...
      -
        type: text
        text: 'to un-favorite it. (Or say something nasty about its mother.)'
  -
    type: paragraph
    content:
      -
    ...
    content:
      -
        ...
        marks:
          -
            type: bold
        text: 'Restore All Factory Presets From ''DCO-106 Presets'''
      -
        type: text
        marks:
          -
      ...
      -
        type: text
        text: 'If any patches from the "factory" DCO-106 bank are edited and saved, selecting this command restores '
      -
        type: text
        marks:
          -
  ...
  -
    ...
    content:
      ...
      -
        type: text
        text: ' of them to their unaltered "factory" setting. At the time of writing, the DCO-106 bank mentioned above is the only factory bank, so this function and the '
      -
        type: text
        marks:
          -
