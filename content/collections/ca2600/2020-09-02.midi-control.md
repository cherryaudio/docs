...
body:
  ...
  -
    ...
    content:
      ...
      -
        type: text
        text: ' section selects whether CA 2600 plays in mono (single-note) or duophonic modes (two-note polyphony) and contains individual CV outputs, as well as a pitch bend depth control. It''s basically the incoming "traffic director" of CA 2600.'
  -
    type: paragraph
    content:
      -
  ...
  -
    ...
    content:
      -
        type: text
        text: 'CA 2600 will usually be played as a monophonic (i.e. one-note-at-a-time) synthesizer, but it includes ARP''s model 3620 keyboard controller "duophonic" (dual-voice) mode.'
  -
    type: bullet_list
    content:
      -
      ...
      values:
        ...
        buttons:
          -
            ...
            url: 'https://docs.cherryaudio.com/cherry-audio/virtual-instruments/ca2600/noise'
            target_blank: false
            color: btn-grey
            size: null
            type: button
