...
body:
  ...
  -
    ...
    content:
      ...
      -
        type: text
        text: '- Clicking and dragging the right edge of the MTL window allows the overall size of the window to be adjusted. This lets you view more or less of the onscreen keyboard. Note that the MTK window''s borders cannot exceed the overall outside dimensions of the CA 2600 window. '
  -
    type: paragraph
    content:
      -
