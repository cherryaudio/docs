...
body:
  ...
  -
    ...
    content:
      ...
      -
        type: text
        text: 'slider, CA 2600 has stepped settings displayed in traditional organ octaves, making it much easier to tune to useful musical intervals. The '
      -
        type: text
        marks:
          -
  ...
  -
    ...
    content:
      ...
      -
        type: text
        text: "\_FM jack. CA 2600 includes separate "
      -
        type: text
        marks:
          -
      ...
      values:
        ...
        buttons:
          -
            ...
            url: 'https://docs.cherryaudio.com/cherry-audio/virtual-instruments/ca2600/vcf'
            target_blank: false
            color: btn-grey
            size: null
            type: button
