...
body:
  ...
  -
    ...
    content:
      ...
      -
        type: text
        text: '- CV mod input for filter resonance (see next section). This is a bipolar control with the middle position representing zero. Negative CV control increases as the knob is dialed to the left; positive CV control increases as the knob is dialed to the right. '
  -
    type: paragraph
    content:
      -
