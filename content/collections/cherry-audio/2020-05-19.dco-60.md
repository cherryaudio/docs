...
body:
    ...
    content:
      -
        ...
        marks:
          -
            type: bold
        text: 'IO Panel Normalization'
  -
    type: paragraph
    content:
      -
        type: text
        text: 'DCO-106 takes advantage of Voltage Modular 2.0’s patch cord normalization feature. This allows modules to be coded to communicate directly with IO Panel connections without the use of patch cords via “invisible” patch cords. The idea is to speed up setup by automatically configuring often-used cables and routings.'
  -
    type: paragraph
    content:
      -
  ...
  -
    ...
    content:
      -
        type: text
        text: 'The LFO section of DCO-106 can optionally take advantage of a normalized IO Panel connection as well (from the '
      -
        type: text
        marks:
          -
    ...
    content:
      -
        ...
        marks:
          -
            type: bold
        text: 'Internal Normalization'
  -
    type: paragraph
    content:
      -
        type: text
        text: "DCO-106 also makes use of a number of internally normalized connections. Looking at the DCO-106 panel, you’ll notice that its sections have the appearance of multiple modules, with inputs at the top and outputs at the bottom. If these sections were standard Voltage modules, you’d need to patch each of them together appropriately to hear sound. (i.e. oscillator output to filter input, filter input to amplifier, etc.) In the DCO-106 module, all of these sections use normalized connections “under the hood,” making it function like a conventional hard-wired standalone synthesizer. But as described above, normalized connections can be overridden by simply plugging cables into the jacks.\_"
  -
    type: set
    attrs:
      values:
  ...
  -
    ...
    content:
      -
        type: text
        text: 'For example, to add a second poly oscillator, you would patch a cable from the IO Panel '
      -
        type: text
        marks:
          -
      ...
      -
        type: text
        text: ' out to a Poly Oscillator, then patch its audio output to DCO-106’s HPF or VCF '
      -
        type: text
        marks:
          -
    ...
    content:
      -
        ...
        marks:
          -
            type: bold
        text: 'One important thing to keep in mind is that normalized input jacks are overridden when a cable is plugged into them, but normalized output jacks are not.'
      -
        type: text
        text: ' Because of this, in the example above, it isn’t necessary to patch a cable from the IO Panel '
      -
        type: text
        marks:
          -
      ...
      -
        type: text
        text: " jack to maintain the IO Panel to DCO connection. In other words, normalized outputs behave as if they’re multed to more than one destination.\_"
  -
    type: heading
    attrs:
      level: 3
  ...
  -
    ...
    content:
      ...
      -
        type: text
        text: '- This is a handy, but potentially confusing feature, so don’t skim this section. If the switch is in the '
      -
        type: text
        marks:
          -
      ...
      -
        type: text
        text: ' position, the LFO is always “on.” Its effect is immediately audible by moving the '
      -
        type: text
        marks:
          -
      ...
      -
        type: text
        text: ' sliders in the DCO and VCF sections. Moving the switch to the '
      -
        type: text
        marks:
          -
      ...
      -
        type: text
        text: ' position activates a normalized connection from the IO Panel CV Sources '
      -
        type: text
        marks:
          -
      ...
      -
        type: text
        text: " jack, and enables control of LFO depth with an external keyboard controller mod wheel. If the mod wheel is all the way down, LFO depth is zero. This makes setting up a mod wheel to add vibrato or wah effects very easy.\_"
  -
    type: paragraph
    content:
      -
  ...
  -
    ...
    content:
      ...
      -
        type: text
        text: " time can be CV controlled with the CV jack and attenuator beneath the slider. The bipolar attenuator knob’s center position is zero; turning it to the right adds positive mod, and turning it to left adds negative mod.\_"
  -
    type: paragraph
    content:
      -
  ...
  -
    ...
    content:
      ...
      -
        type: text
        text: '- Accepts a CV input for pitch. This is normalized from the IO Panel Poly Sources '
      -
        type: text
        marks:
          -
      ...
      -
        type: text
        text: "jack, so in most situations, no connection will be necessary. This input is useful if you’d like to patch in a sequencer or other pitch control voltages. And like all jacks in Voltage 2.0, it’s actually a mult input with unlimited connections, so multiple inputs can be patched in.\_"
  -
    type: paragraph
    content:
      -
        ...
        content:
          -
            ...
            content:
              ...
              -
                type: text
                text: ' slider, and the rate is defined by the LFO section '
              -
                type: text
                marks:
                  -
  ...
  -
    ...
    content:
      -
        type: text
        text: 'In either switch position, the '
      -
        type: text
        marks:
          -
      ...
      -
        type: text
        text: " slider can be CV controlled with the CV jack and attenuator beneath the slider.\_"
  -
    type: paragraph
    content:
      -
      ...
      -
        type: text
        text: '- Adds frequency modulation from the hard-wired low-frequency oscillator section immediately to the left of the DCO. The '
      -
        type: text
        marks:
          -
  ...
  -
    ...
    content:
      ...
      -
        type: text
        text: '- Adds a square wave one octave beneath the current range selection, useful for adding girth to oscillator tones. The '
      -
        type: text
        marks:
          -
      ...
      -
        type: text
        text: ' slider level can be CV controlled with the CV jack and attenuator beneath the slider.'
  -
    type: paragraph
    content:
      -
  ...
  -
    ...
    content:
      ...
      -
        type: text
        text: ' Individual outs jacks for pulse, saw, sub oscillator, noise, and DCO mix output. Sub oscillator and noise outputs are not affected by their corresponding sliders and CV control in the individual outputs, but they will be affected in the '
      -
        type: text
        marks:
          -
  ...
  -
    ...
    content:
      ...
      -
        type: text
        text: ' jack is normalized from the DCO '
      -
        type: text
        marks:
          -
      ...
      -
        type: text
        text: ', so in most situations, no connection will be necessary. This input is useful if you’d like to patch sounds in from additional modules. Remember that connections will override the normalized signal from the the DCO; if you’d like to augment the standard DCO with additional sound sources, simply patch a cable from the desired DCO output to the HPF '
      -
        type: text
        marks:
          -
  ...
  -
    ...
    content:
      ...
      -
        type: text
        text: "- Output of the highpass section. This is normalized to the lowpass filter (VCF) input, so in most cases, it won’t be needed. \_"
  -
    type: heading
    attrs:
      level: 3
  ...
  -
    ...
    content:
      ...
      -
        type: text
        text: '- The poly In jack is normalized from the HFP Out, so in most situations, no connection will be necessary. This input is useful if you’d like to patch sounds in from additional modules.'
  -
    type: paragraph
    content:
      -
  ...
  -
    ...
    content:
      ...
      -
        type: text
        text: "- The Enveople slider sets the amount of envelope modulation applied from the envelope generator. With the invert switch in the up position, envelope affects the cutoff frequency positively. In the down position, envelope mod is inverted for “reverse” effects. The Env slider amount can be CV controlled with the CV jack and attenuator beneath the slider.\_"
  -
    type: paragraph
    content:
      -
      ...
      -
        type: text
        text: '- Adds cutoff frequency modulation from the onboard low-frequency oscillator section. The LFO slider amount can be CV controlled with the CV jack and attenuator beneath the slider.'
  -
    type: paragraph
    content:
      -
  ...
  -
    ...
    content:
      ...
      -
        type: text
        text: '- The poly In jack is normalized from the VCF Out, so in most situations, no connection will be necessary. This input is useful if you’d like to patch sounds in from additional modules.'
  -
    type: paragraph
    content:
      -
      ...
      -
        type: text
        text: "- In the original Juno synths, its main purpose was to act as a master volume control, in order to balance volume levels between presets. Voltage Modular allows volume adjustment in a number of different ways, so its importance isn’t as significant here, but we’ve replicated it as with the original. Typically this gets set to the center zero setting, and volume can be added or subtracted by moving it up or down. The Level slider amount can be CV controlled with the CV jack and attenuator beneath the slider, which can be useful for tremolo effects or wild amplitude modulation effects if the mod source is an audio-rate oscillator.\_"
  -
    type: paragraph
    content:
      -
      ...
      -
        type: text
        text: "- The original Juno synths included a single envelope generator that had to perform double-duty, applying to the lowpass filter as well as the VCA sections. In order to add some flexibility, the Env/Gate switch effectively disconnects the envelope generator from the VCA.\_"
  -
    type: paragraph
    content:
      -
        type: text
        text: "If the Env/Gate switch is in the Env (up) position, the envelope generator affects amplitude (VCA) and filter cutoff (if the the VCF Env slider is up) simultaneously. If the switch is in the down Gate (down) position, the envelope generator still affects filter cutoff, but note amplitude will instantly turn on and off, like an organ.\_"
  -
    type: paragraph
    content:
      -
      ...
      -
        type: text
        text: "- Output of the VCA section. This is normalized to the Chorus section input, so in most cases, it won’t be needed. \_"
  -
    type: heading
    attrs:
      level: 2
  ...
  -
    ...
    content:
      ...
      -
        type: text
        text: "- Output of the VCA section. This is normalized to the VCA input and VCF ENV slider, so in most cases, it won’t be needed. \_"
  -
    type: heading
    attrs:
      level: 3
  ...
  -
    ...
    content:
      ...
      -
        type: text
        text: "- These set the amount of chorus effect. Off is uh… off. The I and II positions are very similar, but the mod speed is slightly faster in the II position. Activating I and II at the same time results in a much faster, mono chorus sound.\_"
  -
    type: heading
    attrs:
      level: 3
