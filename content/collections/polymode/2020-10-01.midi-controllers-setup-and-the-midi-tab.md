...
body:
  ...
  -
    ...
    content:
      -
        type: text
        text: 'This is the quick, "I just want to assign a hardware control right now!," section. We recommend reading this whole section to best take advantage of Polymode''s swift MIDI control assignments. We also recommend reading "'
      -
        type: text
        marks:
          -
            type: italic
        text: "Captains\_and the\_Kings"
      -
        type: text
        text: "\" by Taylor Caldwell\_, but that's not important right now. "
  -
    type: paragraph
    content:
      -
  ...
  -
    ...
    content:
      -
        type: text
        text: 'This is the basic procedure for assigning hardware controllers to almost any Polymode control. '
  -
    type: set
    attrs:
      values:
  ...
  -
    ...
    attrs:
      values:
        type: image
        image:
          - ug_DCO-106_MIDIcont_rightClkColumns-1603998200.jpg
        alignment: left
        add_shadow: false
  -
    type: paragraph
